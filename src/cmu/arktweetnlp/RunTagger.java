...
public class RunTagger {
    ...
    final String propertyFilename = "/cmu/arktweetnlp/Default.properties";
    ...
    int clusterTokens = 0;
    public RunTagger() throws IOException {
        ...
        try {
            ...
            ps.load(in);
            // This should not fail: it's in the resources.
            this.modelFilename = ps.getProperty("pos.model.filename");
//            System.err.printf("Module filename: '%s'\n", this.modelFilename);
        } finally {
            if (in != null)
                in.close();
        }
