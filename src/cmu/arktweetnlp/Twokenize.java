 ...
 * <p>This tokenizer code has gone through a long history: </p>
 * <ol>
 * <li>
 * Brendan O'Connor wrote original version in Python, http://github.com/brendano/tweetmotif
 * TweetMotif: Exploratory Search and Topic Summarization for Twitter.
 * Brendan O'Connor, Michel Krieger, and David Ahn.
 * <a href=http://brenocon.com/oconnor_krieger_ahn.icwsm2010.tweetmotif.pdf>ICWSM-2010 (demo track)</a></li>
 * <li>
 * Kevin Gimpel and Daniel Mills modified it for POS tagging for the CMU ARK Twitter POS Tagger</li>
 * <li>
 * Jason Baldridge and David Snyder ported it to Scala</li>
 * <li>
 * Brendan bugfixed the Scala port and merged with POS-specific changes
 * for the CMU ARK Twitter POS Tagger</li>
 * <li>
 * Tobi Owoputi ported it back to Java and added many improvements (2012-06)</li>
 * </ol>
 * <p>
 * Current home is http://github.com/brendano/ark-tweet-nlp and http://www.ark.cs.cmu.edu/TweetNLP</p>
 * <p>
 * There have been at least 2 other Java ports, but they are not in the lineage for the code here.</p>
 */
